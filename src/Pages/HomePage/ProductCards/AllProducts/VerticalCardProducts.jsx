...
const VerticalCardProducts = ({ heading, category }) => {
        ...
        {loading ? (
            ...
            {categoryLoadingList.map((product, i) => (
              <div key={i} className=" rounded shadow  ">
                <div className="flex items-center p-4 bg-slate-300 overflow-hidden ">
                  <div className=" w-[280px] h-32 "></div>
                </div>
                <div className="px-4 py-2 bg-white">
                  <div className=" w-[280px] h-36 ">
          ...
          <>
            {allProducts.map((product) => (
              <div key={product._id} className=" rounded shadow  ">
                <Link
                  to={`/product/${product._id}`}
                  className="flex items-center p-4 bg-slate-300 overflow-hidden "
                >
                  <div className=" w-[280px] h-32 ">
                    <img
