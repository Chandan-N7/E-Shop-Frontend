...
const RecommendPrdouct = ({ heading, category }) => {
  ...
  return (
    <div className="my-6">
      ...
      <div
        className=" grid lg:grid-cols-4 gap-4 lg:gap-2 md:grid-cols-3 sm:grid-cols-2 sm:px-0 1xsm:px-5"
        ref={scrollElement}
      >
        {loading ? (
          <>
            {categoryLoadingList.map((product, i) => (
              <div key={i} className=" rounded shadow  my-5">
                <div className="flex items-center p-4 bg-slate-300 overflow-hidden ">
                  <div className="w-[300px] h-36 md:w-[300px] sm:w-[250px]  1xsm:w-[350px]"></div>
                </div>
                <div className="px-4 py-2 bg-white">
                  <div className="w-[300px] h-36 md:w-[300px] sm:w-[250px]  1xsm:w-[350px]">
              ...
              <div key={product._id} className=" rounded shadow my-5 ">
                ...
                <div className="px-4 py-2 bg-white">
                  <div className=" h-36 w-full">
                    ...
                    <button onClick={()=>{handleAddToCart(product._id)}} className="text-[0.8rem] w-full mt-4 p-1 text-white font-medium rounded-full border-2 border-red-600 bg-red-600 hover:bg-white hover:text-red-600">
                      Add to Cart
                    </button>
                  </div>
                </div>
...
export default RecommendPrdouct;
